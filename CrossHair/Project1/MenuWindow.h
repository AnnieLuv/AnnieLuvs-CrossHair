...
private:
	...
	std::vector<std::array<int32_t, 2>> trackbar_minmax{
		...
		{ 0,20 }, //dotszminmax
		{ 1,5 },  //thicknessminmax
		{ -10,40 }//centergapminmax
	};


	//x,y,width,height
	std::vector<Gdiplus::Rect> trackbar_rects{
	   Gdiplus::Rect( 10,30,200,30 ),  //crosslen
	   Gdiplus::Rect( 10,90,200,30 ),  //circlesz
	   Gdiplus::Rect( 10,150,200,30 ), //transparency
	   Gdiplus::Rect( 10,210,200,30 ), //dotsz
	   Gdiplus::Rect( 10,270,100,30 ),  //thickness
	   Gdiplus::Rect( 10,330,200,30 )  //centergap
	};
	...
	int32_t button_dim_minclose{ 30 };

	std::vector<Gdiplus::Rect> button_rects{
	   Gdiplus::Rect(280,70,button_width,button_height),  //crosschangecolor
	   Gdiplus::Rect(280,130,button_width,button_height),  //dotchangecolor
	   Gdiplus::Rect(280,190,button_width,button_height), //circlechangecolor
	   Gdiplus::Rect(280,250,button_width,button_height), //resposition
	   Gdiplus::Rect(430,10,button_dim_minclose,button_dim_minclose),                       //minimize
	   Gdiplus::Rect(465,10,button_dim_minclose,button_dim_minclose)                        //maximize
	};

	HWND hwnd_button_minimize{ nullptr };
	HWND hwnd_button_close{ nullptr };
