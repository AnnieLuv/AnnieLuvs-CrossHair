...
const char* title_ch_window = "AnnieLuv's CrossHair";
const char* title_menu_window = "AnnieLuv's CrossHair Menu";
...
void CrossHairDragEnabler(std::shared_ptr<MenuWindow> pMenuWindow) {
    ...
    HWND hwnd{ FindWindow("crosshair", "AnnieLuv's CrossHair") };
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevinstance, PSTR szCmdLine, int iCmdShow) {
    ...
    auto ch_window{ std::make_shared<CrossHairWindow>(pCh,60,60, title_ch_window, "crosshair", hInstance) };
    auto menu_window{ std::make_shared<MenuWindow>(pCh, title_menu_window, "crosshairmenu", hInstance) };
